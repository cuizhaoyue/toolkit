...
// InfoLogger represent the ability to log non-error message, at a particular verbosity.
...
func (l *infoLogger) Info(msg string, fields ...Field) {
	if ce := l.log.Check(l.level, msg); ce != nil {
		ce.Write(fields...)
	}
}
func (l *infoLogger) Infof(format string, args ...interface{}) {
	if ce := l.log.Check(l.level, fmt.Sprintf(format, args...)); ce != nil {
		ce.Write()
	}
}
func (l *infoLogger) Infow(msg string, keysAndValues ...interface{}) {
	if ce := l.log.Check(l.level, msg); ce != nil {
		ce.Write(handleFields(l.log, keysAndValues)...)
	}
}
...
func Infof(msg string, args ...interface{}) { std.Infof(msg, args...) }
func (l *zapLogger) Infof(msg string, args ...interface{}) {
	l.zapLogger.Sugar().Infof(msg, args...)
}

// Infow method output info level log.
func Infow(msg string, keysAndValues ...interface{}) { std.Infow(msg, keysAndValues...) }
...
func Debugw(msg string, keysAndValues ...interface{}) { std.Debugw(msg, keysAndValues...) }
...
func Warnw(msg string, keysAndValues ...interface{}) { std.Warnw(msg, keysAndValues...) }
...
func Errorw(msg string, keysAndValues ...interface{}) { std.Errorw(msg, keysAndValues...) }
...
func Panicw(msg string, keysAndValues ...interface{}) { std.Panicw(msg, keysAndValues...) }
...
func Fatalw(msg string, keysAndValues ...interface{}) { std.Fatalw(msg, keysAndValues...) }

...
// TestCallbacksGetCalled 测试最终执行所有的callback
...
// TestStartGetsCalled 测试执行最后执行manager的Start函数
...
// 测试manager的ShutdownStart执行出现错误时，设置的errorHandler是否执行成功
...
// 测试manager的ShutdownFinish出现错误时，设置的errorHandler是否执行成功
...
// 测试ShutdownCallback出现错误时，设置的errorHandler是否执行成功
